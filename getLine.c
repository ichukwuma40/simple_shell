...
/**
 * get_input - to gets a line minus the newline
 * @info: the parameter struct
 *
 * Return: the bytes read
 */
...
/**
 * _getline - It get the next line of input from STDIN
 * @info: the parameter struct
 * @ptr: this is the address of pointer to buffer, preallocated or NULL
 * @length: it is the size of preallocated ptr buffer if not NULL
 *
 * Return: It will always return s
 */

...
/**
 * get_history_file - to gets the history file
 * @info: the parameter struct
 *
 * Return: it allocate string containg history file
 */
 ...
 *
 * Return: it return 1 on success, else -1
 */
...
/**
 * renumber_history - the renumbers the history linked list after changes
 * @info: the structure containing potential arguments. Used to maintain
 *
